                ...
                filedValueMap.forEach((k, v) -> {
                    switch (k) {
                        ...
                        case Constant.AD_CREATIVE_TABLE_INFO.COLUMN_HEIGHT:
                            creativeTable.setHeight(Integer.parseInt(v));
                            break;
                        case Constant.AD_CREATIVE_TABLE_INFO.COLUMN_WIDTH:
                            creativeTable.setWidth(Integer.parseInt(v));
                            break;
                        case Constant.AD_CREATIVE_TABLE_INFO.COLUMN_AUDIT_STATUS:
                            creativeTable.setAuditStatus(Integer.parseInt(v));
                            break;
    ...
    private void Level4RowData(MySqlRowData rowData) {
        switch (rowData.getTableName()) {
            ...
            case Constant.AD_UNIT_KEYWORD_TABLE_INFO.TABLE_NAME:
                ...
                for (Map<String, String> fileValueMap : rowData.getFieldValueMap()) {
