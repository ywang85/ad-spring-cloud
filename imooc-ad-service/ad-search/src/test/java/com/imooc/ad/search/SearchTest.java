...
public class SearchTest {
    ...
    public void testFetchAds() {
        ...
        // 第一个测试条件
        request.setRequestInfo(new SearchRequest.RequestInfo("aaa", Collections.singletonList(
                new AdSlot("ad-x", 1, 1080, 720, Arrays.asList(1,2,3), 1000)),
                buildExampleApp(),
                buildExampleGeo(),
                buildExampleDevice()));
        ...
        // 第二个测试条件
        request.setRequestInfo(new SearchRequest.RequestInfo("aaa", Collections.singletonList(
                new AdSlot("ad-y", 1, 1080, 720, Arrays.asList(1,2,3), 1000)),
                buildExampleApp(),
                buildExampleGeo(),
                buildExampleDevice()));
    ...
    private App buildExampleApp() {
        return new App("imooc", "imooc", "com.imooc", "com.imooc.video");
    }
    ...
    private Device buildExampleDevice() {
        return new Device("iphone", "0xxxxx", "127.0.0.1", "x", "1080 720",
                "1080 720", "12345678");
    }
